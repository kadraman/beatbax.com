...
- [CLI — Extract instruments from UGE](/docs/tools/cli#extract-instruments-from-uge-files) — build a `.ins` kit from hUGETracker `.uge` files
- [UGE export](/docs/exports/uge) — BeatBax → `.uge` (the reverse direction)
