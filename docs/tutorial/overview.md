...
Optional language topics outside this walkthrough: [Language Reference overview](/docs/language/overview) (grammar map), [Scale awareness](/docs/language/scale), [Imports](/docs/language/imports), [Effects reference](/docs/language/effects).
